...
knitr::include_graphics("tamani-goals.png")
```
]
...
```{r,  echo=F}
knitr::include_graphics("treated.png")
```
]
...
```{r,  echo=F}
knitr::include_graphics("cs-quote-clustering.png")
```
]
...
ggsave("atts_se.png", pse,  width = 9, height = 6)
```

```{r attse, echo=FALSE}
knitr::include_graphics("atts_se.png")
```
]
...
.right-column[
```{r prior1, echo=FALSE}
knitr::include_graphics("b44_intercept_priors.png")
```
]
...
.right-column[
```{r prior2, echo=FALSE}
knitr::include_graphics("b44_beta_priors.png")
```
]
